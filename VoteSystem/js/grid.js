...
function _inLogin(){
	...
	if (loginName==''){
		alert("请输入学号！");
		document.getElementById('valiPic_in').src = 'getValidate.php';
	}
	else if (pwd==''){
		alert("请输入密码！");
		document.getElementById('valiPic_in').src = 'getValidate.php';
...
function _outLogin(){
	...
	if (loginName==''){
		alert("请输入邮箱！");
		document.getElementById('valiPic_out').src = 'getValidate.php';
...
function start_over(){
	$id("start").src="pic/start.png";
}
function start_out(){
	$id("start").src="pic/start_.png";
}
...
function profile_over(){
	$id("prof").src="pic/profile.png";
}
function profile_out(){
	$id("prof").src="pic/profile_.png";
}
function needknow_click(){
	$("#needknow_font").slideToggle();
}
function needknow_over(){
	$id("need").src="pic/needknow.png";
}
function needknow_out(){
	$id("need").src="pic/needknow_.png";
}
function rule_click(){
	$("#rule_font").slideToggle();
}
function rule_over(){
	$id("rule").src="pic/rules.png";
}
function rule_out(){
	$id("rule").src="pic/rules_.png";
}
function contact_click(){
	$("#contact_font").slideToggle();
}
function contact_over(){
	$id("contacting").src="pic/contact.png";
}
function contact_out(){
	$id("contacting").src="pic/contact_.png";
}
		...
		update : function( $item ,$json_det) {
			...
			var $itemEl = this.$item.children( 'a' ),
				eldata = {
					...
					introduce : $json_det['introduce'],
					meterial : $json_det['proof']
				};
